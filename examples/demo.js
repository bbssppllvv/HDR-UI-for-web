...
const strengthWarning = document.querySelector('#strengthWarning');
...
function updateStrength() {
  ...
  root.style.setProperty('--demo-action-hover-strength', `${Math.min(100, Math.round(value * 1.35))}%`);
  strengthValue.value = formattedValue;
  comparisonValue.value = formattedValue;
  strengthWarning.hidden = value <= 40;
}
